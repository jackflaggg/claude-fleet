...
В шапке рядом с `live` висит плашка: «до сброса лимита Claude **4 ч 31 мин** в 19:47». Лимит
привязан к аккаунту, а не к проекту - все сессии во всех папках жгут одну квоту, поэтому
плашка одна на весь борд. Когда пятичасовое окно истекло, там написано «лимит Claude свежий»:
счётчик пойдёт заново с твоего следующего запроса.
